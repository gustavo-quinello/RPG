...
const dadosHabilidades = {
    classes: {
        mago_elemental: [
            { custoMana: 0, custoFoco: 0, custoVida: 0, id: 'me_2', nome: 'Atalho do Mago', desc: 'Atalho do Mago é uma ação bônus que custa 1 ponto de Foco. Para cada ponto de Foco gasto dessa forma, o personagem gera imediatamente 4 pontos de Mana, convertendo concentração em energia mágica de maneira rápida e instintiva.', tier: 1 },
            { custoMana: 0, custoFoco: 0, custoVida: 0, id: 'me_3', nome: 'Finta Improvisada', desc: 'Finta Improvisada é uma ação padrão que custa 2 pontos de Foco. Ao utilizá-la, o personagem substitui sua ação de ataque por uma manobra improvisada, podendo tentar derrubar ou desarmar o alvo.', tier: 1 },
        ...
        mistico: [
            { custoMana: 0, custoFoco: 0, custoVida: 0, id: 'mis_2', nome: 'Atalho do Mago', desc: 'Atalho do Mago é uma ação bônus que custa 1 ponto de Foco. Para cada ponto de Foco gasto dessa forma, o personagem gera imediatamente 4 pontos de Mana, convertendo concentração em energia mágica de maneira rápida e instintiva.', tier: 1 },
            { custoMana: 0, custoFoco: 0, custoVida: 0, id: 'mis_3', nome: 'Finta Improvisada', desc: 'Finta Improvisada é uma ação padrão que custa 2 pontos de Foco. Ao utilizá-la, o personagem substitui sua ação de ataque por uma manobra improvisada, podendo tentar derrubar ou desarmar o alvo.', tier: 1 },
            ...
            { custoMana: 0, custoFoco: 0, custoVida: 0, id: 'mis_5', nome: 'Agilizar Círculo', desc: 'Agilizar Círculo é ativada como uma ação bônus ao custo de 2 pontos de Foco. Essa habilidade permite ativar um círculo mágico utilizando uma ação bônus, em vez de consumir uma ação padrão ou turno completo.', tier: 2 },
        ...
        mago_de_fronte: [
            { custoMana: 0, custoFoco: 0, custoVida: 0, id: 'mf_2', nome: 'Atalho do Mago', desc: 'Atalho do Mago é uma ação bônus que custa 1 ponto de Foco. Para cada ponto de Foco gasto dessa forma, o personagem gera imediatamente 4 pontos de Mana, convertendo concentração em energia mágica de maneira rápida e instintiva.', tier: 1 },
        ...
        fimbulwinter: [
            { custoMana: 0, custoFoco: 0, custoVida: 0, id: 'fi_2', nome: 'Atalho do Mago', desc: 'Atalho do Mago é uma ação bônus que custa 1 ponto de Foco. Para cada ponto de Foco gasto dessa forma, o personagem gera imediatamente 4 pontos de Mana, convertendo concentração em energia mágica de maneira rápida e instintiva.', tier: 1 },
            { custoMana: 0, custoFoco: 0, custoVida: 0, id: 'fi_3', nome: 'Finta Improvisada', desc: 'Finta Improvisada é uma ação padrão que custa 2 pontos de Foco. Ao utilizá-la, o personagem substitui sua ação de ataque por uma manobra improvisada, podendo tentar derrubar ou desarmar o alvo.', tier: 1 },
        ...
        feengari: [
            { custoMana: 0, custoFoco: 0, custoVida: 0, id: 'fe_2', nome: 'Atalho do Mago', desc: 'Atalho do Mago é uma ação bônus que custa 1 ponto de Foco. Para cada ponto de Foco gasto dessa forma, o personagem gera imediatamente 4 pontos de Mana, convertendo concentração em energia mágica de maneira rápida e instintiva.', tier: 1 },
            { custoMana: 0, custoFoco: 0, custoVida: 0, id: 'fe_3', nome: 'Finta improvisada', desc: 'Finta Improvisada é uma ação padrão que custa 2 pontos de Foco. Ao utilizá-la, o personagem substitui sua ação de ataque por uma manobra improvisada, podendo tentar derrubar ou desarmar o alvo.', tier: 1 },
        ...
        ascendente: [
            { custoMana: 0, custoFoco: 0, custoVida: 0, id: 'as_2', nome: 'Atalho do Mago', desc: 'Atalho do Mago é uma ação bônus que custa 1 ponto de Foco. Para cada ponto de Foco gasto dessa forma, o personagem gera imediatamente 4 pontos de Mana, convertendo concentração em energia mágica de maneira rápida e instintiva.', tier: 1 },
        ...
        atirador_de_elite: [
            ...
            { custoMana: 0, custoFoco: 0, custoVida: 0, id: 'ae_2', nome: 'Finta Improvisada', desc: 'Finta Improvisada é uma ação padrão que custa 2 pontos de Foco. Ao utilizá-la, o personagem substitui sua ação de ataque por uma manobra improvisada, podendo tentar derrubar ou desarmar o alvo.', tier: 1 },
        ...
        charlatao: [
            ...
            { custoMana: 0, custoFoco: 0, custoVida: 0, id: 'cha_2', nome: 'Finta improvisada', desc: 'Finta Improvisada é uma ação padrão que custa 2 pontos de Foco. Ao utilizá-la, o personagem substitui sua ação de ataque por uma manobra improvisada, podendo tentar derrubar ou desarmar o alvo.', tier: 1 },
        ...
        alquimista: [
            ...
            { custoMana: 0, custoFoco: 0, custoVida: 0, id: 'alq_2', nome: 'Finta improvisada', desc: 'Finta Improvisada é uma ação padrão que custa 2 pontos de Foco. Ao utilizá-la, o personagem substitui sua ação de ataque por uma manobra improvisada, podendo tentar derrubar ou desarmar o alvo.', tier: 1 },
        ...
        artifice: [
            ...
            { custoMana: 0, custoFoco: 0, custoVida: 0, id: 'art_2', nome: 'Finta improvisada', desc: 'Finta Improvisada é uma ação padrão que custa 2 pontos de Foco. Ao utilizá-la, o personagem substitui sua ação de ataque por uma manobra improvisada, podendo tentar derrubar ou desarmar o alvo.', tier: 1 },
    ...
    auras: {
        ...
        transformacao: [
            {custoMana: 0, custoFoco: 0, custoVida: 0, id: 'tra_1', nome: 'Agilizar Tempo', desc: 'Agilizar Tempo é usada como uma ação bônus ao custo de 12 pontos de Mana. Ao ativá-la, o personagem recebe imediatamente uma ação de movimento adicional na rodada.', tier: 1 },
            { custoMana: 0, custoFoco: 0, custoVida: 0, id: 'tra_2', nome: 'Adrenalina', desc: 'Adrenalina é uma reação que custa 6 pontos de Mana. Ao utilizá-la, o personagem recebe imediatamente uma ação de movimento adicional, podendo agir mesmo fora do próprio turno.', tier: 2 },
            { custoMana: 0, custoFoco: 0, custoVida: 0, id: 'tra_3', nome: 'Agilizar Tempo II', desc: 'Agilizar Tempo II é uma ação bônus que custa 15 pontos de Mana. Ao utilizá-la, o personagem recebe imediatamente uma ação padrão adicional na rodada.', tier: 3 },
        ],
...
const dadosMagias = {
    ...
    feengari: [
        ...
        { custoMana: (n, a) => 120 + Math.floor((n+a.intelecto)/5), custoFoco: 0, custoVida: 0, id: 'fee_8', tier: 5, nome: 'Grito do Abismo', desc: 'O conjurador libera um grito distorcido e antinatural que se propaga em cone, causando dano massivo e desorientação mental. Alvos afetados têm seus movimentos prejudicados temporariamente caso não resistam à pressão psicológica do som. Gasta uma quantidade massiva de mana. Nos níveis altos possui uma versão especial.<span class="termo-destaque" data-tooltip="Custo: 120 + (MP / 5) mana\nCanalização: 3 turnos\nÁrea: cone médio (15 m)\nDano: etéreo\nEfeito: [MP/1,5 d20]\nResistência: Presença [DT 15 + MP]\n–1 movimento por 1 rodada">Informações Detalhadas</span>' },
    ],
    ascendente: [
